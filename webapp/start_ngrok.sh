...
export CORS_ORIGINS="http://localhost:5000,http://127.0.0.1:5000,http://localhost:5001,http://127.0.0.1:5001,https://*.ngrok.io,https://*.ngrok-free.app,https://*.ngrok-free.dev"
